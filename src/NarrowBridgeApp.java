...
//	private JLabel bridgeThroughputModeLabel = new JLabel("Bridge mode:", JLabel.RIGHT);
	...
	private JTextField busesOnBridgeTextField = new JTextField("Bridge is empty");
	...
	private SimulationManager simulationManager = new SimulationManager(null, drawPanel, 1000, busesInQueueTextField, busesOnBridgeTextField);
...
//	}
	...
	private void updateSimulationBridgeThroughputMode() {
		BridgeThroughput bridgeThroughput = BridgeThroughput.MANY_BUSES_ONE_WAY;
	...
	private void updateBridgeThroughput() {
		...
		( BridgeThroughput.MANY_BUSES_ONE_WAY).setbusLimit(busLimit);
	}
...
//	}
	...
	private void updateMaxBusesOnBridgeSpinner() {
		BridgeThroughput bt = BridgeThroughput.MANY_BUSES_ONE_WAY;
